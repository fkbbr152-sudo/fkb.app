		...
		<header id="header">
			<nav id="nav">
			  ...
			  <ul id="menu" role="menu">
						...
						<li><a href="#sessao10" id="btn-link2">BLOG</a></li>
		...
		<div class="logo-mobile"><img src="img/logofkb.png"/></div>
          ...
          <div class="sub-menu">
			<p class="p">Horário de Funcionamento : 13:30 às 17:00 e das 18:30 às 22:00<br>
             ...
             <h3>Vestibular 2º Semestre 2022</h3>
			<?php
				include_once("controler/conexao.php");
				$result_psu = "SELECT * FROM arquivos ORDER BY id_arquivos DESC LIMIT 1";
				$resultado_psu = mysqli_query($conn, $result_psu);
		  		$row_psu = mysqli_fetch_assoc($resultado_psu);
				
				$result_edital = "SELECT * FROM arquivos_edital ORDER BY id_arquivos DESC LIMIT 1";
				$resultado_edital = mysqli_query($conn, $result_edital);
		  		$row_edital = mysqli_fetch_assoc($resultado_edital);
			?>
                ...
                <form action="arquivos/edital_geral_03_maio.pdf" target="_blank"><input type="submit" class="btn_submit_cad" value="EDITAL GERAL"></form>

                <form action="arquivos/resultado_edital/<?php echo $row_edital['arquivo'];?>" target="_blank"><input type="submit" class="btn_submit_cad" value="EDITAL DIVULGAÇÃO DE RESULTADOS"></form>
         
                <form action="arquivos/resultado_psu/<?php echo $row_psu['arquivo'];?>" target="_blank"><input type="submit" class="btn_submit_cad" value="RESULTADO DA CLASSIFICAÇÃO<?php echo $row_psu['nome_arq'];?>"></form> 
			...
			<script>
				...
				function exibeMensagem() {
					Swal.fire({
						 ...
						 '<a href="arquivos/Comunicado de Rematrícula.pdf" id="bli" target="_blank">✓ Comunicado e Portarias para rematrícula</a><br><br>' +
						 ...
						 '<a href="arquivos/Requerimento de Rematrícula Novo.pdf" id="bli" target="_blank">✓ Requerimento para Rematrícula</a><br><br>'+
			...
			<script>
				...
				function exibeMensagem() {
					Swal.fire({
						 ...
						 '<a href="arquivos/biblioteca/Comunicado Geral Biblioteca Lambert Prins FKB Fevereiro 2022.pdf" id="bli" target="_blank">✓ COMUNICADO GERAL 2022.</a>',
						});
					};</script>
			...
			<script>
				...
				function exibeMensagem() {
					Swal.fire({
						  ...
						  '<iframe src="view/estagio_site.php"  width="100%" height="450px">'+
						  '',
						});
					};</script>
...
-->
	...
	<section class="app">
        ...
        <div class="container_car">
			<div class="carterinha_um">
				<span class="titulo-app">Portal do aluno das faculdades FKB agora em suas mãos</span>
			
				<div class="img-cen">
					<img src="img/fkb.png" alt="imagem-central">
				</div><br>
				<p class="sec_text">BAIXE AGORA O APLICATIVO NO SEU CELULAR!</p>
				<p class="sec_text_sub">Instale o aplicativo. Depois de instalado os usuários de Apple/IOS deverão informar o <strong><b>código da instituição: fkb.</b></strong> Realize o acesso informando seu RA como login (respeitando a pontuação do RA)
				e o CPF (somente números) como senha. 
					<div class="container-center">
					<div class="botao">
					<a class="bt-app" href="https://play.google.com/store/apps/details?id=br.com.qualinfo.app.acadweb.fkb" target="_blank"><img src="img/disponivel-google-play-badge-6.png" alt="disponivel-google-play-badge-6" /></a>
					<a class="bt-app" href="https://apps.apple.com/br/app/acadweb-app/id1336479713#?platform=iphone" target="_blank"><img src="img/disponivel-na-app-store-botao-10.png" alt="disponivel-na-app-store" /></a>
					</div>
					<div class="qrcode">
						<img src="img/qrcode_play.google.com.png" alt="qr-google">
						<img src="img/qrcode_apps.apple.com.png" alt="qr-apple">
					</div>
				</div>
			</div>

			<div class="carterinha_dois">
	...
	<section id="sessao10" class="sessao10">
		<iframe class="ifr-2" src="blog/index.html" width="100%" height="1200px" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
	</section>

	<section id="sessao9" class="sessao9">
    <div class="noticias">
      <h1>NOTÍCIAS</h1>
	  <iframe class="ifr" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Ffkbsocial%2Fposts%2F3209658549253188&show_text=true&width=370" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
	  <iframe class="ifr" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Ffkbsocial%2Fposts%2F3195831630635880&show_text=true&width=370" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
	  <iframe class="ifr" src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2Ffkbsocial%2Fvideos%2F967585820584600%2F&show_text=true&width=370&t=0" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
	  <iframe class="ifr" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Ffkbsocial%2Fposts%2F3195828917302818&show_text=true&width=370" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
	  <iframe class="ifr" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Ffkbsocial%2Fposts%2F3195828087302901&show_text=true&width=370" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
	  <iframe class="ifr" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Ffkbsocial%2Fposts%2F3190958581123185&show_text=true&width=370" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
	...
	<h1 id="tutorial">Pós-graduação em Educação Epecial na FKB</h1>
	<div id="9" style="display:flex;">

	<img alt="Inclusão é na FKB"
			 data-type="youtube"
			 data-videoid="c43LEgPO3Bc"
			 data-description="Pós-graduação em Educação Especial">	 
	</div> 
				...
				function exibeMensagem() {
					Swal.fire({
						...
						'Ênfase em Deficiência Visual<br><br>'+
						  ...
						  '<form action="arquivos/pos-graduacao/calendario letivo de educação especial.pdf" target="_blank"><input type="submit" class="btn_submit_cad" value="✓ CALENDÁRIO LETIVO"></form>'+
						 '<form action="arquivos/pos-graduacao/Informações do curso.pdf" target="_blank"><input type="submit" class="btn_submit_cad" value="✓ INFORMAÇÃO SOBRE O CURSO"></form>'+
						 '<form action="arquivos/pos-graduacao/matriz curricular educação especial.pdf" target="_blank"><input type="submit" class="btn_submit_cad" value="✓ MATRIZ CURRICULAR"></form>'+
						 '<form action="arquivos/pos-graduacao/professores.pdf" target="_blank"><input type="submit" class="btn_submit_cad" value="✓ PROFESSORES"></form>',
						});
					};</script>
			</div>
    </section>
                        ...
                        <script>
                            ...
                            function exibeMensagem() {
                                Swal.fire({
                                    ...
                                    'Sr. Alexandre Valentino Freire<br><br>'+
                                    '<b>E-mail:</b><br><br>'+
            
                                    '<b>Secretária:</b><br><br>' +
                                    'Srª. Jacqueline Audrey Carvalho Venâncio<br><br>'+
                                    '<b>E-mail:</b><br><br>',
                                    });
                                };
                        </script>
...
<div class="modal-wrapper">
	<div class="modal">
	  ...
	  <div class="content">
		  <div class="good-job">
			<img class="img-pop" src="img/logofkb.png"><br><br>
			<p><php 
				// include_once "controler/conexao.php";
